...
public class ChatScrollToBottomObserver extends RecyclerView.AdapterDataObserver {

    private RecyclerView mRecycler;
    private RecyclerView.Adapter<?> mAdapter;
    private LinearLayoutManager mManager;

    public ChatScrollToBottomObserver(RecyclerView recycler, RecyclerView.Adapter<?> adapter, LinearLayoutManager manager) {
